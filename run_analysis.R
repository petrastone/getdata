...
# This form is tidy. There is one variable in
# each column, and each row represents the average of observations for a subject and activity type
...
## OTHER TIDY GUIDELINES
# Fixed vars before measured vars

## 5 COMMON PROBLEMS
# Column headers are values not var names
# Multiple vars in one column
# vars stored in both rows and columns
# Multiple observational units in same table
# Single observational unit stored in multiple tables

## TIDY TOOLS
# tidy dataset is input and tidy dataset is output
